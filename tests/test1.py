...
class MyTestCase(unittest.TestCase):
    ...
    def test_make_lists_name_num_1(self):
        ...
        count = 3
        list_names, list_nums = lab3.functions.make_lists_name_num(list_users, count)
    ...
    def test_get_issue_item_to_time_1(self):
        ...
        field = 'status'
        toString = 'Closed'
        res = lab3.functions.get_issue_item_to_time(data,field,toString)
    ...
    def test_get_issue_item_to_time_2(self):
        ...
        field = 'status'
        to = '6'
        res = lab3.functions.get_issue_item_to_time(data, field, to)
        base = datetime.datetime.strptime('2022-06-22T08:27:32.763+0000', '%Y-%m-%dT%H:%M:%S.%f%z')
        self.assertEqual(res, [base])
    ...
    def test_status_statistic_1(self):
        ...
        data = json.load(f)
        f.close()
        opened, in_progress, resolved, reopened, patch_available = lab3.functions.status_statistic(data)
    ...
    def test_get_resolved_time_for_assignee_1(self):
        ...
        data = json.load(f)
        f.close()
        res = lab3.functions.get_resolved_time_for_assignee(data,'cadonna')
    ...
    def test_get_resolved_time_for_assignee_2(self):
        ...
        data = json.load(f)
        f.close()
        res = lab3.functions.get_resolved_time_for_assignee(data,'nehanarkhede')
